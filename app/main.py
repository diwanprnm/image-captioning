...
from app.exceptions import VisionServiceError, vision_service_exception_handler
...
app.add_exception_handler(VisionServiceError, vision_service_exception_handler)
